...
class StoryBrain {
//Uncomment the lines below to include storyData as a private property in StoryBrain.
  ...
  //Use the storyNumber property inside getStory(), getChoice1() and getChoice2() so that it gets the updated
  // story and choices rather than always just the first (0th) one.
...
//Create a method called nextStory(), it should not have any outputs but
